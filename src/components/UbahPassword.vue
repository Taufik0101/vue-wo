...
<!--              <div class="row gy-4">-->
                <div class="col-lg-12 form-group">
                  ...
                  <input type="password" v-model="update.opassword" name="name" class="form-control" id="name" placeholder="Password Lama" required>
                </div>
                <div class="col-lg-12 form-group">
                  <label style="font-weight: bold">Password Baru</label>
                  <input type="password" class="form-control" name="email" id="email" placeholder="Password Baru" v-model="update.npassword" required>
                </div>
<!--              </div>-->
              <div class="form-group">
                <label style="font-weight: bold">Konfirmasi Password</label>
                <input type="password" class="form-control" name="subject" id="subject" placeholder="Konfirmasi Password" v-model="update.confirm" required>
              </div>
              <div class="my-3">
