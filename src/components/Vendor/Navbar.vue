        ...
        <li class="dropdown">
          <a href="#" data-bs-toggle="dropdown"
            ...
            <div class="d-none d-md-block d-lg-inline-block">
              Hi, {{ local.name }}
              <span class="badge bg-info">{{ local.category }}</span>
            </div>
          </a>
          <div class="dropdown-menu dropdown-menu-end">
            <router-link :to="{ name: 'profileVendor' }" class="dropdown-item">
              <i data-feather="user"></i>Profile
            </router-link>
            <router-link :to="{ name: 'ubahPasswordVendor' }" class="dropdown-item">
...
export default {
  ...
  setup() {
    ...
    const local = reactive({
      ...
      category: localStorage.getItem("kategori"),
